        ...
        <div className="modal-dialog" style={{width:'75%',maxWidth:'80%'}} role="document">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title text-muted" id="exampleModalLongTitle">Review and Edit Resume Data</h5>
            ...
            <div className="modal-body">
              <div className="container">
                <h3 className="text-dark text-uppercase">{this.props.name} {this.props.surname}</h3>
                ...
                <button className='btn btn-danger btn-block text-uppercase font-weight-bold rounded-0' onClick={this.props.toggleModal}>Close</button>
              </div>
            </div>
          </div>
        </div>
