                  ...
                  <tr key={index}>
                    {
                      this.props.entries.map(
                        name => {
                          if(name === 'delete'){
                            return <td key={name}><button className='btn btn-sm btn-danger p-1 rounded-0 d-inline' onClick={()=>this.props.handleDelete(this.props.title.toLowerCase(),this.props.data[index]['id'])}>Remove {this.props.title}</button></td>
                          }
